    ...
    <View>
      ...
      >
        <View>
          ...
          <FontAwesome name="money" size={20} color="#65B741"  style={{justifyContent:"center"}}/>
          <Text style={{ marginTop: 3, fontSize: 18, fontWeight: "500", marginLeft:10, paddingTop:-10, color:"#61A3BA"}}>
